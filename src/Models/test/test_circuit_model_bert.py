...
def test_l0_calc_bert():
    circuit_config = CircuitConfig(
        mask_method="continuous_sparsification",
        mask_hparams={"ablation": "none", "mask_bias": True, "mask_init_value": 0.0},
        target_layers=[
...
def test_temperature():
    ...
    circuit_config = CircuitConfig(
        mask_method="continuous_sparsification",
        mask_hparams={"ablation": "none", "mask_bias": False, "mask_init_value": 1.0},
        target_layers=[
            "bert.encoder.layer.0.output.dense",
        ],
        freeze_base=True,
...
def test_compute_l0_loss_bert():
    ...
    circuit_config = CircuitConfig(
        mask_method="continuous_sparsification",
        mask_hparams={"ablation": "none", "mask_bias": False, "mask_init_value": 0.75},
        target_layers=[
            "bert.encoder.layer.0.output.dense",
        ],
        freeze_base=True,
