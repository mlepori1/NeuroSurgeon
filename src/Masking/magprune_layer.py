...
class MagPruneLayer(MaskLayer):
    def __init__(
        self, ablation: str, mask_bias: bool, mask_percentage: float
    ):
...
class MagPruneLinear(MagPruneLayer):
    ...
    @classmethod
    def from_layer(
        self, layer: nn.Linear, ablation, mask_bias, mask_percentage
    ):
...
class MagPruneGPTConv1D(MagPruneLayer):
    ...
    @classmethod
    def from_layer(
        self, layer: Conv1D, ablation, mask_bias, mask_percentage
    ):
...
class MagPruneConv2d(_MagPruneConv):
    ...
    @classmethod
    def from_layer(
        self, layer: nn.Conv2d, ablation, mask_bias, mask_percentage
    ):
        if layer.bias is not None:
            bias = True
        else:
...
class MagPruneConv1d(_MagPruneConv):
    ...
    @classmethod
    def from_layer(
        self, layer: nn.Conv1d, ablation, mask_bias, mask_percentage
    ):
        if layer.bias is not None:
            bias = True
        else:
